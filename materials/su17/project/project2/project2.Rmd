...
**Deadline.** This project is due at 11:59pm on Tuesday 7/25. Late submissions will be accepted until Sunday, 7/30, but a 10% late penalty will be applied for each day late. It's **much** better to be early than late, so start working now.

**Checkpoint.** For full credit, you must also **complete Parts 1 and 2 of the project (out of 5) and submit them by 11:59pm on Friday, 7/21**.
...
```{python manual_problem_id=murder_rates_3}
...
```{python for_assignment_type=student, manual_problem_id=changes_in_murder_rates_5}
...
<!-- #region {"for_assignment_type": "student", "manual_problem_id": "death_penalty_1"} -->
...
<!-- #region {"manual_problem_id": "death_penalty_2"} -->
...
```{python manual_problem_id=death_penalty_5}
samples = make_array()
...
<!-- #region {"for_assignment_type": "student", "manual_problem_id": "death_penalty_6"} -->
**P-value:** ...
...
<!-- #region {"manual_problem_id": "visualization_2"} -->
*Write your answer here, replacing this text.*
<!-- #endregion -->
...
<!-- #region {"manual_problem_id": "visualization_4"} -->
*Write your answer here, replacing this text.*
<!-- #endregion -->

<!-- #region {"manual_problem_id": "visualization_5"} -->
