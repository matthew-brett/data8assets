...
**Deadline**: If you are not attending lab physically, you have to complete this lab and submit by Thursday, 6/22 11:59pm in order to receive lab credit. Otherwise, please attend the lab you are enrolled in, get the check-off with your (u)GSI or learning assistant **AND** submit this assignment (with whatever progress you've made) to receive lab credit.
